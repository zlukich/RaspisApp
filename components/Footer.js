...
<feBlend mode="normal" in2="shape" result="effect1_innerShadow"/>
            ...
            <BottomNavigationAction onClickCapture={()=>navigation.navigate('Info')} label="Favorites" value="info" icon={<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
